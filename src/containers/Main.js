...
class Main extends React.Component {
  ...
  render () {
     ...
     */
    let {stargazers, additionalStargazers, children} = this.props;
    ...
    return (
      <div className="Main">
        ...
        <Link style={{marginLeft: 20}} to="/page2">{'LINK TO PAGE 2'}</Link>
        <div className="Main-contents">
          {children ? cloneElement(children, this.props) : null}
        </div>
